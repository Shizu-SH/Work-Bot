...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'work-bot', thumbnail: imagen1, sourceUrl: 'https://github.com/Shizu-Hub/work-bot-presentacion' }}}}, { quoted: m })
